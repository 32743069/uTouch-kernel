...
#if defined(CONFIG_TCHIP_DDR_KINGSTON_D2516EC4BXGG_PATCH)
#define DDR3_DDR2_DLL_DISABLE_FREQ    (250)  // 颗粒dll disable的频率
#define DDR3_DDR2_ODT_DISABLE_FREQ    (250)  //颗粒odt disable的频率
#elif defined(CONFIG_TCHIP_DDR_ADATA_D2ND1211A_PATCH)
#define DDR3_DDR2_DLL_DISABLE_FREQ    (125)  // 颗粒dll disable的频率
#define DDR3_DDR2_ODT_DISABLE_FREQ    (125)  //颗粒odt disable的频率
#else
...
#define PHY_ODT_DISABLE_FREQ          (266)  //定义主控端odt disable的频率
