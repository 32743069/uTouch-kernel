...
*/
   ...
   new_camera_device_ex(RK29_CAM_SENSOR_BF3920,
                         ...
                         INVALID_VALUE,
                        TC_CAMERA_BACK_DN_PIN,
                        CONS(RK29_CAM_SENSOR_BF3920,_PWRDN_ACTIVE),
                         false,
    ...
    new_camera_device_ex(RK29_CAM_SENSOR_BF3703,
			...
			90,
                        ...
                        INVALID_VALUE,
                        TC_CAMERA_BACK_DN_PIN,
                        CONS(RK29_CAM_SENSOR_BF3703,_PWRDN_ACTIVE),
                        false,
    ...
    new_camera_device_ex(RK29_CAM_SENSOR_SIV121D,
			    ...
			    INVALID_VALUE,
			    TC_CAMERA_BACK_DN_PIN,
			    CONS(RK29_CAM_SENSOR_SIV121D,_PWRDN_ACTIVE),
			    false,
			    CONS(RK29_CAM_SENSOR_SIV121D,_FULL_RESOLUTION),
			    0,
			    1,
			    250000,
			    CONS(RK29_CAM_SENSOR_SIV121D,_I2C_ADDR),
			    0,
			    24),
#endif
...
*/
    ...
    new_camera_device_ex(RK29_CAM_SENSOR_GC0311,
			    ...
			    INVALID_VALUE,
			    TC_CAMERA_FRONT_DN_PIN,
			    CONS(RK29_CAM_SENSOR_GC0311,_PWRDN_ACTIVE),
			    false,
    ...
    new_camera_device_ex(RK29_CAM_SENSOR_GC0309,
			    ...
			    INVALID_VALUE,
			    TC_CAMERA_FRONT_DN_PIN,
			    CONS(RK29_CAM_SENSOR_GC0309,_PWRDN_ACTIVE),
			    false,
