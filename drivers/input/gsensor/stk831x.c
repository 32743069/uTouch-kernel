...
//#ifdef STK_ALLWINNER_A20	
	int tmp;
	int x,y,z;
	int orientation[] = {1, 0, 0, 0, 0, 1, 0, -1, 0};
//#endif	
	if(event_since_en < 1200)
	{
		...
		x = stk->raw_data[0]*orientation[0] + stk->raw_data[1]*orientation[1] + stk->raw_data[2]*orientation[2];
		y = stk->raw_data[0]*orientation[3] + stk->raw_data[1]*orientation[4] + stk->raw_data[2]*orientation[5];
		z = stk->raw_data[0]*orientation[6] + stk->raw_data[1]*orientation[7] + stk->raw_data[2]*orientation[8];
	...
	//stk->raw_data[2] = stk->raw_data[2] * 981 / 965 ;
		...
		input_report_abs(stk->input_dev, ABS_X, x); //x
		input_report_abs(stk->input_dev, ABS_Y, y); //y
		input_report_abs(stk->input_dev, ABS_Z, z); //z
