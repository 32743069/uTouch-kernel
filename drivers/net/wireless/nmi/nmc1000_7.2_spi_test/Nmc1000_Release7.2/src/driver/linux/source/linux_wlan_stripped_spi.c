...
int custom_spi_write(uint32_t, uint8_t *, uint32_t);	// tony
...
//static int custom_spi_write(uint32_t addr, uint8_t *buf, uint32_t size)	// tony comment out static 
int custom_spi_write(uint32_t addr, uint8_t *buf, uint32_t size)	// tony comment out static 
{
	int result;
